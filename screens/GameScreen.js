  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.list}>
        <ScrollView contentContainerStyle={styles.listCointainer}>
          {pastGuesses.map((guess, index) => renderListItem(guess, pastGuesses.lenght - index))}
        </ScrollView>
      </View>
    </View>
  );
